...
func main() {
	// single cert
	creds, err := credentials.NewClientTLSFromFile("/opt/gopath/src/github.com/xiaotuancai/grpc/test/single-cert/ca.crt",
		"peer0.org3.example.com")

	// double cert
	//creds, err := credentials.NewClientTLSFromFile("/opt/gopath/src/github.com/xiaotuancai/grpc/test/double-cert/server_ca.crt",
	...
	conn, err := grpc.DialContext(ctx, "127.0.0.1:34516", grpcOptions...)
	if err != nil {
