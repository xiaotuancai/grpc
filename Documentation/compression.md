...
servers is to use
[`encoding.RegisterCompressor`](https://godoc.org/github.com/xiaotuancai/grpc/encoding#RegisterCompressor)
...
it via the
[`UseCompressor`](https://godoc.org/github.com/xiaotuancai/grpc#UseCompressor)
`CallOption`.  Remember that `CallOption`s may be turned into defaults for all
calls from a `ClientConn` by using the
[`WithDefaultCallOptions`](https://godoc.org/github.com/xiaotuancai/grpc#WithDefaultCallOptions)
